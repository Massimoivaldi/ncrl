...
class Euroteam_Ncrl_Block_Adminhtml_Model_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText() {
        if (Mage::registry('model_data') && Mage::registry('model_data')->getId()) {
            return Mage::helper('newspaper')->__("Edit Item %s", $this->htmlEscape(Mage::registry('model_data')->getId()));
        } else {
