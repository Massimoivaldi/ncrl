...
class Euroteam_Ncrl_Block_Adminhtml_Field_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    public function _construct() {
        $this->setId('newspaper_field_grid');
    ...
    protected function _prepareCollection() {
        $collection = Mage::getModel('newspaper/field')->getCollection();
