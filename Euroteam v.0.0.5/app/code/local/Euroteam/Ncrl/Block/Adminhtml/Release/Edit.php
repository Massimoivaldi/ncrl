...
class Euroteam_Ncrl_Block_Adminhtml_Release_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText() {
        if (Mage::registry('release_data') && Mage::registry('release_data')->getId()) {
            return Mage::helper('newspaper')->__("Edit Item %s", $this->htmlEscape(Mage::registry('release_data')->getId()));
        } else {
