...
class Euroteam_Ncrl_Block_Adminhtml_Field_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText() {
        if (Mage::registry('field_data') && Mage::registry('field_data')->getId()) {
            return Mage::helper('newspaper')->__("Edit Item %s", $this->htmlEscape(Mage::registry('field_data')->getId()));
        } else {
